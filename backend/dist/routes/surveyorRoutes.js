...
async function sendToPotholeModel(imagePath) {
    ...
    const response = await axios.post("https://mynkchnn-pothole-detection-api.hf.space/detect_with_visualization", form, {
        headers: {
            ...form.getHeaders(),
...
surveyorRouter.put("/acceptAssignment/:routeAssignmentId", requireAuth, requireRole("SURVEYOR"), async (req, res) => {
...
surveyorRouter.post("/assignments", requireAuth, requireRole("SURVEYOR"), async (req, res) => {
