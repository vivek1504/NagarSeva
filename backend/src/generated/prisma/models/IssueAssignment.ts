...
// @ts-nocheck 
/*
 * This file exports the `IssueAssignment` model and its related types.
 *
...
export type GetIssueAssignmentAggregateType<T extends IssueAssignmentAggregateArgs> = {
      [P in keyof T & keyof AggregateIssueAssignment]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateIssueAssignment[P]>
    : Prisma.GetScalarType<T[P], AggregateIssueAssignment[P]>
}
...
type GetIssueAssignmentGroupByPayload<T extends IssueAssignmentGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<IssueAssignmentGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof IssueAssignmentGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], IssueAssignmentGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], IssueAssignmentGroupByOutputType[P]>
      }
    >
  >
...
export type IssueAssignmentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<IssueAssignmentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface IssueAssignmentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['IssueAssignment'], meta: { name: 'IssueAssignment' } }
  /**
   ...
   * })
  **/
  count<T extends IssueAssignmentCountArgs>(
    args?: Prisma.Subset<T, IssueAssignmentCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], IssueAssignmentCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends IssueAssignmentGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, IssueAssignmentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetIssueAssignmentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
